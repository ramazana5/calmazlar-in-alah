...
if(message.author.id !== message.guild.owner.user.id) return message.channel.send(`Bu komutu kullanabilmek için "\`sunucu sahiibi olmaslısın\`" yetkisine sahip olmalısın.`);
